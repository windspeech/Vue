		...
		<div class="food-content">
			...
			<div class="content">
				...
				<div class="detail">
					...
					<span class="rating">好评率{{food.raiting}}%</span>
				</div>
				<div class="price">
				...
				<div @click.stop.prevent="addFirst" class="buy" v-show="!food.count || food.count===0" transition="fade">加入购买</div>
			</div>
